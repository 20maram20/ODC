class exams {
  ...
  exams({this.code, this.message, this.data});
...
class Data {
  ...
  Data({this.id, this.examSubject, this.examDate, this.examStartTime, this.examEndTime, this.final1});
